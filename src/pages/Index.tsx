...
const reviews = [
  { name: 'Артём К.', avatar: 'А', rating: 5, text: 'Купил аккаунт MM2 с годли ножами — всё выдали за 2 минуты, данные рабочие. Топ магазин!' },
  { name: 'Данил В.', avatar: 'Д', rating: 5, text: 'Брал Blox Fruits макс лвл, всё честно. Поддержка ответила ночью за 5 минут.' },
  { name: 'София М.', avatar: 'С', rating: 5, text: 'Донат аккаунт пришёл моментально, робуксы на месте. Уже третий раз покупаю тут.' },
  { name: 'Никита Р.', avatar: 'Н', rating: 4, text: 'Pet Simulator аккаунт норм, петы редкие. Единственное — ждал минут 10, но всё выдали.' },
  { name: 'Егор Т.', avatar: 'Е', rating: 5, text: 'Цены реально ниже чем везде. Взял сразу два аккаунта, оба рабочие. Рекомендую!' },
  { name: 'Милана Ж.', avatar: 'М', rating: 5, text: 'Grow a Garden PRO — сад просто огонь, редкие мутации. Спасибо большое!' },
];
